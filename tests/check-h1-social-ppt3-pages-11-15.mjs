...
assert.ok(
  shell.includes('src="../index.html?report=h1&embedded=1&v=20260731-ai-frame58-lightbox-v1"'),
...
assert.equal(
  [...shell.matchAll(/h1-figma-racing-theme\.css\?v=20260731-ai-frame58-lightbox-v1/g)].length,
  2,
