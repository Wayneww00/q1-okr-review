...
assert.ok(
  shell.includes('src="../index.html?report=h1&embedded=1&v=20260729-figma-direct-p25-p40-v6"'),
...
assert.equal(
  [...shell.matchAll(/h1-figma-racing-theme\.css\?v=20260729-figma-direct-p25-p40-v6/g)].length,
  2,
