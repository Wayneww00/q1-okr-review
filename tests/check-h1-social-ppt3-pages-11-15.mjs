...
assert.ok(
  shell.includes('src="../index.html?report=h1&embedded=1&v=20260731-o2-india-proof-below-v3"'),
...
assert.equal(
  [...shell.matchAll(/h1-figma-racing-theme\.css\?v=20260731-o2-india-proof-below-v3/g)].length,
  2,
