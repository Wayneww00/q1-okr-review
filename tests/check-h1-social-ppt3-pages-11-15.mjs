...
assert.ok(
  shell.includes('src="../index.html?report=h1&embedded=1&v=20260730-figma-feathered-edge-v23"'),
...
assert.equal(
  [...shell.matchAll(/h1-figma-racing-theme\.css\?v=20260730-figma-feathered-edge-v16/g)].length,
  2,
