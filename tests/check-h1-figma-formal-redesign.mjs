...
assert.ok(formal.includes('src="../index.html?report=h1&embedded=1&v=20260801-unified-visual-release-v1"'), "the formal report must keep login-free embedded mode");
