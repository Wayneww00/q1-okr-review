...
assert.ok(formal.includes('src="../index.html?report=h1&embedded=1&v=20260730-figma-feathered-edge-v23"'), "the formal report must keep login-free embedded mode");
