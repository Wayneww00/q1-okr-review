...
assert.ok(
  formal.includes('href="h1-figma-racing-theme.css?v=20260731-endorsement-frame45-v1"'),
  "the formal shell must load the high-contrast chart and region-table stylesheet",
);
assert.ok(
  formal.includes("figmaTheme.href = '/previews/h1-figma-racing-theme.css?v=20260731-endorsement-frame45-v1';"),
