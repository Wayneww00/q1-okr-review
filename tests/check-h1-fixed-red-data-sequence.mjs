...
assert.ok(
  formal.includes('src="../index.html?report=h1&embedded=1&v=20260731-delivery-ppt88-v1"'),
  "the local formal deck must keep the same embedded H1 report",
);
assert.ok(
  formal.includes('href="h1-figma-racing-theme.css?v=20260731-delivery-ppt88-v1"'),
  "the formal shell must load the high-contrast chart and region-table stylesheet",
);
assert.ok(
  formal.includes("figmaTheme.href = '/previews/h1-figma-racing-theme.css?v=20260731-delivery-ppt88-v1';"),
